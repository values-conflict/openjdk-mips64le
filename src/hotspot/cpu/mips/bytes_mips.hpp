...
#ifndef CPU_MIPS_BYTES_MIPS_HPP
#define CPU_MIPS_BYTES_MIPS_HPP
...
class Bytes: AllStatic {
 public:
  ...
  // Efficient swapping of byte ordering (inlined from former bytes_linux_mips.inline.hpp)
