...
class Argument {
 ...
 public:
  enum {
    ...
    n_int_register_parameters_j   = 8, // a0-a7 (RA0-RA7, r4-r11) for Java calls
    n_float_register_parameters_j = 8, // f12-f19 for Java calls
    n_int_register_parameters_c   = 8, // same for C calls (N64 ABI)
