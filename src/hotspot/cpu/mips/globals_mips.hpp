...
#ifndef CPU_MIPS_GLOBALS_MIPS_HPP
#define CPU_MIPS_GLOBALS_MIPS_HPP
...
// Loom continuation stubs not yet implemented for MIPS; Loom/virtual-threads not needed for Jenkins
...
#endif // CPU_MIPS_GLOBALS_MIPS_HPP
