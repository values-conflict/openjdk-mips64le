...
#ifndef CPU_MIPS_FRAME_MIPS_HPP
#define CPU_MIPS_FRAME_MIPS_HPP
...
//    [ argument word 0          ] <--- S7
 ...
 public:
  enum {
    ...
    entry_frame_after_call_words                     = 23,  // TODO: verify for mips
    ...
    metadata_words                                   =  2,
    // size, in words, of metadata at frame bottom
    metadata_words_at_bottom                         = metadata_words,
    // size, in words, of frame metadata at the frame top
