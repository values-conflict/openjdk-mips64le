...
void VM_Version::get_processor_features() {
  ...
  // supports_cx8 is now const in jdk25u (always true for 64-bit)
...
void VM_Version::initialize_cpu_information() {
  // Stub: CPU information initialization for MIPS
  // JFR/perf CPU info is not yet implemented for MIPS.
}
