...
#ifndef CPU_MIPS_CONTINUATIONHELPER_MIPS_INLINE_HPP
#define CPU_MIPS_CONTINUATIONHELPER_MIPS_INLINE_HPP
...
inline intptr_t* ContinuationHelper::InterpretedFrame::frame_top(const frame& f, InterpreterOopMap* mask) {
...
inline intptr_t* ContinuationHelper::InterpretedFrame::frame_bottom(const frame& f) {
  return (intptr_t*)f.at_relative(frame::interpreter_frame_locals_offset) + 1;
}
...
#endif // CPU_MIPS_CONTINUATIONHELPER_MIPS_INLINE_HPP
