...
#define REG_SP  29
#define REG_FP  30
#define REG_BCP 16   // BCP = S0 = register 16
...
// get_previous_fp removed from os interface in jdk25u; keep as local helper
static intptr_t* __attribute__((noinline)) get_previous_fp() {
  int *pc;
  intptr_t sp;
  int *pc_limit = (int*)(void*)&get_previous_fp;
  int insn;
...
// is_allocatable removed from os interface in jdk25u
...
void os::print_register_info(outputStream* st, const void* context, int& continuation) {
  ...
  while (n < register_count) {
    continuation = n + 1;
#define CASE_PRINT_REG(n, str) case n: st->print(str); print_location(st, (intptr_t)uc->uc_mcontext.gregs[n]);
    switch (n) {
      CASE_PRINT_REG( 0, "ZERO="); break;
      CASE_PRINT_REG( 1, "AT=");   break;
      CASE_PRINT_REG( 2, "V0=");   break;
      CASE_PRINT_REG( 3, "V1=");   break;
      ...
      CASE_PRINT_REG(16, "S0=");   break;
      CASE_PRINT_REG(17, "S1=");   break;
      CASE_PRINT_REG(18, "S2=");   break;
      CASE_PRINT_REG(19, "S3=");   break;
      CASE_PRINT_REG(20, "S4=");   break;
      CASE_PRINT_REG(21, "S5=");   break;
      CASE_PRINT_REG(22, "S6=");   break;
      CASE_PRINT_REG(23, "S7=");   break;
      CASE_PRINT_REG(24, "T8=");   break;
      CASE_PRINT_REG(25, "T9=");   break;
      CASE_PRINT_REG(26, "K0=");   break;
      CASE_PRINT_REG(27, "K1=");   break;
      CASE_PRINT_REG(28, "GP=");   break;
      CASE_PRINT_REG(29, "SP=");   break;
      CASE_PRINT_REG(30, "FP=");   break;
      CASE_PRINT_REG(31, "RA=");   break;
      default: st->print("REG%d=", n); print_location(st, 0); break;
    }
#undef CASE_PRINT_REG
    ++n;
    if (n < register_count) st->cr();
  }
  st->cr();
}
